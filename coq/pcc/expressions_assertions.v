...
| sub_nsfield : forall e e0 fid, sub_exp e e0 -> 
    sub_exp e (nsfield e0 fid)
| sub_plus : forall e e0 e1, sub_exp e e0 \/ sub_exp e e1 -> 
    sub_exp e (plus e0 e1)
| sub_guarded : forall e e0 e1 e2, 
    sub_exp e e0 \/ sub_exp e e1 \/ sub_exp e e2 -> 
    sub_exp e (guarded e0 e1 e2).

Definition ghost_expr e := 
